...
VALUES
-- =====================================================================
-- BRONZE ORDER 1: Small/medium reference tables - 8 tables, <10K rows each
-- =====================================================================
...
VALUES
-- =====================================================================
-- BRONZE LAYER CONFIGURATIONS (101-113) - 11 Blackboard Source Tables
-- Full extract from Blackboard, MERGE to Bronze, CDF enabled for Silver incremental
...
(101, 'source_details', 'query', 'SELECT * FROM cdm_lms.term'),
...
(101, 'target_details', 'if_duplicate_primary_keys', 'warn'), 
...
(102, 'source_details', 'query', 'SELECT * FROM cdm_lms.person_course'),
(102, 'source_details', 'staging_lakehouse_name', 'LearningPlatforms_Bronze'),
(102, 'source_details', 'staging_folder_path', 'Blackboards/CDM_LMS/person_course/'),
(102, 'target_details', 'merge_type', 'append'),
(102, 'target_details', 'enable_change_data_feed', 'true'),
(102, 'target_details', 'if_duplicate_primary_keys', 'warn'), 
...
(103, 'source_details', 'query', 'SELECT * FROM cdm_lms.institution_hierarchy'),
...
(103, 'target_details', 'if_duplicate_primary_keys', 'warn'), 
...
(104, 'source_details', 'query', 'SELECT * FROM cdm_lms.institution_hierarchy_course'),
...
(104, 'target_details', 'if_duplicate_primary_keys', 'warn'), 
...
(105, 'source_details', 'query', 'SELECT *, Stage:service_level AS service_level FROM cdm_lms.course'),
...
(106, 'source_details', 'query', 'SELECT * FROM cdm_lms.person'),
...
(107, 'source_details', 'query', 'SELECT * FROM cdm_lms.gradebook'),
...
(108, 'source_details', 'query', 'SELECT * FROM cdm_lms.course_item'),
...
(109, 'source_details', 'query', 'SELECT * FROM cdm_lms.evaluable_item'),
...
(110, 'source_details', 'query', 'SELECT * FROM cdm_lms.grade'),
...
(111, 'source_details', 'query', 'SELECT * FROM cdm_lms.course_activity'),
